...
def generate_single_pdf_heatmap(
    ...
    # Remove columns that specialist does not use:
    if remove_specialist_columns:
        # Hills columns to remove
        # 2.2, 2.4, 3.0, 3.2, 3.8, 4.0
        # Rough columns to remove
...
if __name__ == "__main__":
    ...
    # Specialist with removed columns
    ...
    # Comparison with smaller figure size

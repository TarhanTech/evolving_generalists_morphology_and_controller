...
class AntProblem(Problem):
    def __init__(self, individuals: List[Individual]):
        ...
        morph_leg_width_lower_bounds = [individuals[0].morphology.leg_width_range[0]] * 8
        ...
        morph_leg_length_upper_bounds = [individuals[0].morphology.leg_length_range[1]] * 8
        morph_leg_width_upper_bounds = [individuals[0].morphology.leg_width_range[1]] * 8
    ...
    def evals(self, params: torch.Tensor, ind: Individual) -> float:
        nn_params, morph_params = torch.split(params, (ind.controller.total_weigths, ind.morphology.total_genes))
    ...
    def _evaluate_batch(self, solutions: evotorch.SolutionBatch):
        ...
        for i in range(0, len(solutions.values), batch_size):
            ...
            batch_fitness = joblib.Parallel(n_jobs=6)(tasks)
